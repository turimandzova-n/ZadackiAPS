...
public class zadaca111 {
	...
	private static void zadaca(DLL<Integer> lista1) {
	...
	while(tmp!=null) {
		...
		while(tmp1!=null && tmp1.succ!=null && tmp1.element<tmp1.succ.element) {
			if(brojac==1) {
				pom=tmp1;
			}
...
/* Da se najde najgolemata rastecka podniza i da se stave vo druga lista*/