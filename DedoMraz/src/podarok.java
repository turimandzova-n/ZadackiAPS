...
public class podarok {
	public static void main(String[] args) throws IOException {
		...
		int h = tabela.search(s1);
		if(h==-1) {
			System.out.println("Ne postoi takvo ime");

		}
		else {
			String podaroce=tabela.buckets[h].value;
			System.out.println(podaroce);
