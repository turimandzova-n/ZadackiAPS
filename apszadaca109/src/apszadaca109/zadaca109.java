...
public class zadaca109 {
    public static void main(String [] args) throws IOException {
        ...
        i
        nt n = Integer.parseInt(br.readLine()); //broj na elementi vo lusta
        ...
        int pozicija=zadaca107(lista, x);
        System.out.println(pozicija);

    }
    public static int zadaca107(SLL<Integer> lista, int x)
    {
